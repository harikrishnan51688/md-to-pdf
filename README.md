...
- [scripts/generate_pdfs.py](scripts/generate_pdfs.py) — orchestrates conversion and watermarking.
- [scripts/watermark.py](scripts/watermark.py) — creates and merges a centered watermark.
- [scripts/detect_changed_files.py](scripts/detect_changed_files.py) — selects which .md files to process.
